...
\textbf{Facts:}
\begin{itemize}
\item For a merge between 2 arrays of size $x$, the number of comparisons is at most $2x$, which means every element in the 2 arrays could experience at most 1 comparisons.
